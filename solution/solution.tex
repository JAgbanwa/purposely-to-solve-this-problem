...
the impossible congruence $b^2 \equiv 4 \pmod{9}$, while analysis \emph{modulo 27}
shows $e + 2w^2 \equiv -1 \pmod 3$ (where $e = (b^2-1)/9$) giving a further
necessary condition on the 3-adic structure of solutions.
...
\begin{lemma}[Parity of $y$ and $z$]\label{lem:parity}
...
\begin{lemma}[$3 \mid z$]\label{lem:3divz}
...
\begin{lemma}[$b^2 \equiv 1 \pmod 9$]\label{lem:bmod9}
...
\begin{lemma}[Modulo-27 relation]\label{lem:mod27}
...
\begin{lemma}[$X \equiv 2 \pmod 9$]\label{lem:Xmod9}
